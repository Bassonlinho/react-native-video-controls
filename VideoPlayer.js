...
export default class VideoPlayer extends Component {
    ...
    constructor(props) {
        ...
        this.events = {
            ...
            onSeekbarSlideComplete: this.onSeekbarSlideComplete.bind(this),
            onSeekbarValueChange: this.onSeekbarValueChange.bind(this),
    ...
    */
    ...
    _onProgress(data = {}) {
        ...
        if (!state.seeking) {
            this.state.sliderValue = state.currentTime / state.duration;
        }
    ...
    */
    ...
    seekTo(time = 0) {
        ...
        if (this.props.onSeek) {
            this.props.onSeek(state.currentTime, time);
        }
    ...
    reset() {
        ...
        state.paused = true;
        state.currentTime = 0;
        this.setState(state, () => this.player.ref.seek(state.currentTime));
    }
    ...
    */
    ...
    onSeekbarValueChange(newValue) {
        if (this.state.showControls) {
            this.resetControlTimeout();
            this.state.sliderValue = newValue;

            let state = this.state;
            if (this.slidePauseState == null) {
                this.slidePauseState = state.paused;
            }
            state.paused = true;
            this.setState(state);
        }
    ...
    onSeekbarSlideComplete(newValue) {
        if (this.state.showControls) {
            this.resetControlTimeout();
            this.state.sliderValue = newValue;
            const time = this.state.duration * newValue;
            ...
            state.paused = this.slidePauseState;
            this.slidePauseState = null;
            this.setState(state);
        }
    }
    ...
    */
    ...
    renderVolume() {
        ...
        const { volumeIcon, minTrackColor } = this.props;

        const icon = this.state.volume > 0 ? volumeIcon : volumeIcon;
    ...
    renderSeekbar() {
        return (
            <Slider
                ...
                minimumTrackTintColor={this.props.seekColor || '#FFF'}
                maximumTrackTintColor={'#FFF'}
                thumbTintColor={'#FFF'}
                maximumValue={1}
                minimumValue={0}
                value={this.state.sliderValue}
                onSlidingComplete={this.events.onSeekbarSlideComplete}
                onValueChange={this.events.onSeekbarValueChange}
            />
        );
    }
    ...
    renderPlayPause() {
        ...
        return this.renderControl(
            <Animated.View style={[
                ...
                <Image source={source} style={{ marginTop: 20, alignSelf: "center" }} />
            </Animated.View>,
